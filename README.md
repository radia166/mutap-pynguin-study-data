...
File: [Appendix_1_Module_Level_Comparison.xlsx](Appendix_1_Module_Level_Comparison.xlsx), [CSV](CSV/Appendix_1_Module_Level_Comparison.csv)
...
File: [Appendix_2_Mutation_Comparison_OpenSource.xlsx](Appendix_2_Mutation_Comparison_OpenSource.xlsx),[CSV](CSV/Appendix_2_Mutation_Comparison_OpenSource.csv)
...
File: [Appendix_3_Mutation_Comparison_Industrial.xlsx](Appendix_3_Mutation_Comparison_Industrial.xlsx) [CSV](CSV/Appendix_3_Mutation_Comparison_Industrial.csv) 
...
File: [Appendix_4_Mutation_vs_Coverage_OpenSource.xlsx](Appendix_4_Mutation_vs_Coverage_OpenSource.xlsx)[CSV](Appendix_4_Mutation_vs_Coverage_OpenSource.csv)
...
File: [Appendix_5_Coverage_Industrial.xlsx](Appendix_5_Coverage_Industrial.xlsx)[CSV](Appendix_5_Coverage_Industrial.csv)
...
File: [Appendix_6_Quality_vs_Time_OpenSource.xlsx](Appendix_6_Quality_vs_Time_OpenSource.xlsx)[CSV](CSV/Appendix_6_Quality_vs_Time_OpenSource.csv)
...
File: [Appendix_7_Quality_vs_Time_Industrial.xlsx](Appendix_7_Quality_vs_Time_Industrial.xlsx)[CSV](CSV/Appendix_7_Quality_vs_Time_Industrial.csv)
...
File: [Appendix_8_Test_Complexity_Summary.xlsx](Appendix_8_Test_Complexity_Summary.xlsx)[CSV](CSV/Appendix_8_Test_Complexity_Summary.csv)
